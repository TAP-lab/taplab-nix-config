...
{   
  ...
  home.file.".zshrc".text = ''
    ...
    alias syncstore="nix-copy-closure --to root@192.168.1.182 $(nix-store -qR /nix/store/*) && ssh root@192.168.1.182 'nix store sign --all --key-file /nix-serve-private --extra-experimental-features nix-command'";
